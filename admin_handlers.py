...
@admin_router.message(Command("start"), F.from_user.id.in_(ADMIN_IDS)) # 👈 Filtrni qo'shing
@admin_router.message(Command("admin_menu"), F.from_user.id.in_(ADMIN_IDS)) # 👈 Filtrni qo'shing
